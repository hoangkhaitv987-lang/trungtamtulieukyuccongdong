...
$gallery_images = [];
try {
    // 1. Lấy ảnh từ CỘNG ĐỒNG (tag 'a50')
    $sql_gallery = "SELECT p.duong_dan_media, p.tieu_de
                    FROM bai_dang p
                    ...
                    WHERE p.trang_thai = 'approved' 
                      ...
                      AND (n.slug = 'a50' OR n.ten = 'A50')
                    ORDER BY p.ngay_tao DESC
                    LIMIT 12"; 
    
    $stmt = $pdo->query($sql_gallery);
    $gallery_images = $stmt->fetchAll(PDO::FETCH_ASSOC);

} catch (Exception $e) {
    // Nếu có lỗi CSDL, trang vẫn chạy
}
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <title>Thông tin A50 - CỔNG THÔNG TIN TRUNG TÂM TƯ LIỆU VÀ KÝ ỨC CỘNG ĐỒNG</title>
    ...
    <style>
        ...
        .community-cta-section { margin-bottom: 25px; background-color: #a54646; border-radius: 8px; padding: 30px; text-align: center; } /* Đổi màu */
...
<body>
        ...
        <nav class="nav-bar">
            <div class="ochuathongti">
                <ul>
                    ...
                    <li><a href="thongtina50.php" style="background-color: #9a0202;">Thông tin A50</a></li>
        ...
        <div class="ochuathongti content-wrapper">          
            ...
            <section class="info-card intro-section">
                <header class="info-card__header">
                    <h3 class="info-card__title"><i class="fas fa-info-circle"></i> Giới thiệu về Lễ diễu binh A50</h3>
                </header>
                <div class="info-card__body">
                    <p>Kỷ niệm 50 năm Ngày Thống nhất đất nước (30/4/1975 - 30/4/2025) là sự kiện lịch sử trọng đại của dân tộc. Lễ diễu binh, diễu hành A50 được tổ chức long trọng nhằm ôn lại chặng đường lịch sử vẻ vang, khẳng định những thành tựu to lớn mà đất nước đã đạt được.</p>
                    <p>Sự kiện là dịp biểu dương sức mạnh của khối đại đoàn kết toàn dân tộc, thể hiện lòng biết ơn sâu sắc đối với các thế hệ cha anh đã hy sinh vì độc lập, tự do và thống nhất Tổ quốc.</p>
                    
                    <h4><i class="fas fa-calendar-alt"></i> Thông tin chính về sự kiện</h4>
                    <ul>
                        <li><strong>Thời gian:</strong> 7:00 sáng, ngày 30/04/2025</li>
                        <li><strong>Địa điểm:</strong> Đường Lê Duẩn, TP.Hồ Chí Minh các tuyến phố chính.</li>
                        <li><strong>Quy mô:</strong> Cấp Quốc gia, với sự tham gia của các lực lượng vũ trang và các khối diễu hành đại diện cho nhân dân.</li>
                    </ul>
                </div>
            </section>
            ...
            <section class="info-card video-section">
                 <header class="info-card__header">
                    <h3 class="info-card__title"><i class="fas fa-video"></i> Video về A50</h3>
                 </header>
                 <div class="info-card__body">
                    <div class="video-grid">
                        <div class="video-item">
                            ...
                            <p class="video-caption">Tổng hợp Lễ diễu binh Kỷ niệm 50 năm (Nguồn: VTV24)</p>
                        </div>
                        <div class="video-item">
                            <video controls preload="metadata">
                                <source src="khovideo/a50/NSND Tạ Minh Tâm, Phương Mỹ Chi, Double2T hòa giọng trong Lễ Kỷ niệm 50 năm thống nhất đất nước.mp4" type="video/mp4"> 
                            </video>
                            <p class="video-caption">Lễ Kỷ niệm 50 năm thống nhất đất nước</p>
                        </div>
                    </div>
                 </div>
            </section>
            ...
            <section class="info-card gallery-section">
                 <header class="info-card__header">
                    <h3 class="info-card__title"><i class="fas fa-images"></i> Thư viện hình ảnh A50</h3>
                 </header>
                 <div class="info-card__body">
                    <div class="gallery-grid">
                        <img src="khoanh/a50/_DMH8224.jpg" alt="Hình ảnh A50 1">
                        <img src="khoanh/a50/_DMH8539.jpg" alt="Hình ảnh A50 2">
                        <img src="khoanh/a50/_DMH8328.jpg" alt="Hình ảnh A50 3">
                        <img src="khoanh/slide/_DMH8293.jpg" alt="Hình ảnh A50 4">
                        <img src="khoanh/a50/_DMH8362.jpg" alt="Hình ảnh A50 5">
                        <img src="khoanh/a50/_DMH8463.jpg" alt="Hình ảnh A50 6">
            ...
            <section class="community-cta-section">
                <h3><i class="fas fa-users"></i> CHIA SẺ KÝ ỨC</h3>
                <p>Tham gia cộng đồng để chia sẻ câu chuyện, hình ảnh và cảm xúc của bạn về các sự kiện lịch sử!</p>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // 1. Thu thập tất cả nguồn ảnh từ thư viện
        ...
        // 4.  click cho từng ảnh trong grid
